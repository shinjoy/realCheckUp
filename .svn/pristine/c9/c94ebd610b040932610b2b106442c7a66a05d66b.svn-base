...
<script type="text/javascript">
	...
	function searchList(listForm,page) {
		...
		$.ajax({
			type:"POST",
			url:"/admin/board/app/app_list.go",
			dataType:"html",
			data:param,
						...
						<div class="contents-top">
							<div class="top-tools">
								<div class="search-tool">
 								...
 								<div class="btn-tools"><button class="btn-blue" onclick="document.location.href='/admin/board/app/app_edit.go?appSeq=0';">앱버전 등록</button></div>
							</div>
						</div>
